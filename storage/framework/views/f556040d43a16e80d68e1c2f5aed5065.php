<div>
    <div class="max-w-7xl mx-auto">
        <div class="mt-6 mb-4 rounded-sm bg-white shadow border px-6 py-6">
            ...
            <?php if($checkedModules && ! $canEvents && ! $canCampaigns): ?>
...
<?php $component = WireUi\View\Components\ModalCard::resolve(['title' => 'Módulos Disponíveis','maxWidth' => '2xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'showModuleSelectionModal','persistent' => true]); ?>
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/livewire/dashboard/home.blade.php ENDPATH**/ ?>