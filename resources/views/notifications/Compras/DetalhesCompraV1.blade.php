                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="margin:0;padding-top:25px;padding-bottom:25px;padding-left:35px;padding-right:35px;font-size:0">
                                                                    <a target="_blank" href="#/" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#ED8E20;font-size:16px">
                                                                        <img src="{{ appUrl() }}/{{ asset('images/icones/pay-check.png') }}" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="120" height="115">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;margin:0;padding-bottom:10px">
                                                                    <h2 style="text-align: center; margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#333333">{{ $data['event']['event_name'] ?? 'EVENTO' }}</h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;margin:0;padding-top:15px;padding-bottom:20px">
                                                                    <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:36px;color:#777777;font-size:24px; text-align: center;"><strong class="font-size:28px;">{{ $data['name'] }}</strong>, compa confirmada! Segue abaixo todas as informações e link para acesso online.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                ...
                                                                <td bgcolor="#eeeeee" align="left" style="margin:0;padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px">
                                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation">
                                                                        <tr style="border-collapse:collapse">
                                                                            ...
                                                                            <td width="50%" style="padding:0;margin:0">
                                                                                <div style="text-align:right; margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);font-weight:900;">{{ $data['order_control'] }}</div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                <tr style="border-collapse:collapse">
                                                                    <td align="left" style="margin:0;">
                                                                        @foreach ($data['itens'] as $itemKey => $itemValues)
                                                                            <table width="100%" style="margin-top:2px;" cellspacing="1" cellpadding="1" border="0">
                                                                                <tr style="border-collapse:collapse; background-color: #f7f7f7;">
                                                                                    <td style="padding:3px 10px;margin:0" width="80%" align="left">
                                                                                        <p style="padding:0; margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:16px;font-weight:600;"># {{ $itemKey + 1 }} - {{ $itemValues['item_description'] ?? null }}</p>
                                                                                        <p style="padding:0; margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:20px;color:#333333;font-size:14px">{{ strtoupper($itemValues['user_name'] ?? null) }}</p>
                                                                                    </td>
                                                                                    <td style="padding:3px 10px;margin:0" width="20%" align="right">
                                                                                        <div style="text-align: right; margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:16px">R$ {{ ($itemValues['item_amount'] ?? false) ? number_format(($itemValues['item_amount'] ?? false ?? 0) / 100 , 2, ',', '.') : '0,00' }}</div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        @endforeach
                                                    ...
                                                    <td valign="top" align="center" style="padding:0;margin:0;width:530px">
                                                                ...
                                                                <td align="left" style="margin:0;">
                                                                    <table width="100%" style="margin-top:2px;" cellspacing="1" cellpadding="1" border="0">
                                                                        <tr style="border-collapse:collapse;">
                                                                            ...
                                                                            <td style="padding:3px 10px;margin:0" width="20%" align="right">
                                                                                <h4 style="margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">{{ ($data['order_amount'] ?? false) ? 'R$ ' . number_format(($data['order_amount'] ?? 0) / 100 , 2, ',', '.') : '0,00' }}</h4>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <table width="100%" style="margin-top:2px;" cellspacing="1" cellpadding="1" border="0">
                                                                        <tr style="border-collapse:collapse;">
                                                                            <td style="padding:3px 10px;margin:0" width="80%" align="left">
                                                                                <h4 style="margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">
                                                                                    DESCONTO
                                                                                    @if (($data['code_promo_id'] ?? false) && ($data['code_promo'] ?? false))
                                                                                        <span style="font-weight:400;">{{ $data['code_promo']['code_name'] }}</span>
                                                                                        @if ($data['code_promo']['code_description'] ?? false)
                                                                                            <span style="font-weight:400;">- {{ $data['code_promo']['code_description'] }}</span>
                                                                                        @endif
                                                                                    @endif
                                                                                </h4>
                                                                            </td>
                                                                            <td style="padding:3px 10px;margin:0" width="20%" align="right">
                                                                                <h4 style="margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">{{ ($data['code_promo_discount_amount'] ?? false) ? 'R$ ' . number_format(($data['code_promo_discount_amount'] ?? 0) / 100 , 2, ',', '.') : '0,00' }}</h4>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <table width="100%" style="margin-top:2px;" cellspacing="1" cellpadding="1" border="0">
                                                                        <tr style="border-collapse:collapse;">
                                                                            ...
                                                                            <td style="padding:3px 10px;margin:0" width="20%" align="right">
                                                                                <h4 style="margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">{{ ($data['order_amount_pay'] ?? false) ? 'R$ ' . number_format(($data['order_amount_pay'] ?? 0) / 100 , 2, ',', '.') : '0,00' }}</h4>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                        ...
                                                        @if (count($data['payments']))
                                                            @foreach ($data['payments'] as $payment)
                                                                @if (!in_array($payment['status'],listOrderStatusPaid()))
                                                                @continue
                                                                @endif
                                                                            ...
                                                                            <table width="100%" style="margin-top:2px;" cellspacing="1" cellpadding="1" border="0">
                                                                                <tr style="border-collapse:collapse;">
                                                                                    <td style="padding:3px 10px;margin:0" width="50%" align="left">
                                                                                        ...
                                                                                        <div style="font-weight:800;margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 18px; color: rgb(95, 95, 95);">{{ __($payment['pay_type']) }}</div>
                                                                                        <div style="font-size:14px;color:#333333;">
                                                                                            @if (in_array(strtoupper($payment['pay_type']),["CREDIT_CARD","CARD_CREDIT"]))
                                                                                                <div style="text-transform: uppercase;">
                                                                                                    <span>{{ $payment['pay_card_brand'] }}</span>
                                                                                                    @if ($payment['pay_card_last'] ?? false)
                                                                                                    <span>FINAL {{ $payment['pay_card_last'] }}</span>
                                                                                                    @endif
                                                                                                </div>
                                                                                            @elseif (strtoupper($payment['pay_type']) == "TRANSFER_PIX" && $payment['pay_pix_key'])
                                                                                                <div>
                                                                                                    <span>{{ $payment['pay_pix_key'] }}</span>
                                                                                                </div>
                                                                                            @elseif (strtoupper($payment['pay_type']) == "CUPOM_FULL")
                                                                                                <div>
                                                                                    ...
                                                                                    <td style="padding:3px 10px;margin:0" width="50%" align="right">
                                                                                        <div style="font-weight:600;margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">{{ $payment['paid_label'] }}</div>
                                                                                        <div style="font-size:14px;color:rgb(95, 95, 95);">NSU <span style="color:#333333;font-weight:600;">{{ $payment['pay_nsu'] }}</span></div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                ...
                                                <tr style="border-collapse:collapse">
                                                    <td valign="top" align="center" style="padding:0;margin:0;width:530px">
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;margin:0;">
                                                                    <h2 style="margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:24px;font-style:normal;font-weight:bold;color:#ffffff; text-align: center">{{ $data['event']['event_tickets_nomenclature'] ?? 'INGRESSO' }} DIGITAL</h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
