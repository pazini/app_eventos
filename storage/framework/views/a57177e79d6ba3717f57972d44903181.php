            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3">
                <div class="flex-1">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-white">Últimas Vendas de Campanhas</h1>
                            <p class="text-white/90 text-sm">Monitoramento em tempo real das vendas das campanhas</p>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__currentLoopData = $orders ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                $statusLabelGrid =
                                    mb_strtolower($statusLabelRaw) === 'aguardando pagamento'
                                        ? 'Aguardando Pg'
                                        : $statusLabelRaw;
                                $displayValue = $order_item->amount_paid ?: $order_item->amount_total;
                            ?>
                            <tr class="hover:bg-gray-50 cursor-pointer"
                                ...
                                <td class="px-4 py-3">
                                    <div class="text-sm text-gray-700"><?php echo e($order_item->campaign->name ?? '--'); ?>

                                    </div>
                                    <div class="text-xs text-gray-500 uppercase">
                                        <?php echo e($order_item->campaign->organizer->organizer_name_full ?? '--'); ?></div>
                                </td>
            ...
            <div class="space-y-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <?php if (isset($component)) { $__componentOriginal53cf851b4d6af185b0b5e0467ca69b92 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53cf851b4d6af185b0b5e0467ca69b92 = $attributes; } ?>
<?php $component = WireUi\View\Components\Button::resolve(['outline' => true,'icon' => 'link','href' => ''.e(route('adesao-localizador', ['localizador' => $selectedOrder->order_control])).'','label' => 'Abrir Adesão'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(WireUi\View\Components\Button::class))->getConstructor()): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        ...
                        <div class="text-base font-semibold text-gray-900">
                            <?php echo e($selectedOrder->campaign->organizer->organizer_name_full ?? '--'); ?></div>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div class="text-xs font-medium text-gray-500 uppercase mb-1">Campanha</div>
                        <div class="text-base font-semibold text-gray-900">
                            <?php echo e($selectedOrder->campaign->name ?? '--'); ?></div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="bg-white rounded-lg p-3 border border-gray-200">
                            <div class="text-xs font-medium text-gray-500 uppercase mb-1">Documento</div>
                        ...
                        <div class="bg-white rounded-lg p-3 border border-gray-200">
                            ...
                            <div class="text-sm font-semibold text-gray-900">
                                <?php echo e(($selectedOrder->buyer_contact_country ?? '55') . ' ' . ($selectedOrder->buyer_contact_ddd ?? '') . ' ' . ($selectedOrder->buyer_contact_num ?? '')); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-white rounded-lg p-3 border border-gray-200">
                            ...
                            <div class="text-base font-bold text-gray-900">
                                <?php echo e(toMoney($selectedOrder->amount_total ?? 0, 'R$ ')); ?></div>
                        </div>
                        <div class="bg-red-50 rounded-lg p-3 border border-red-200">
                            ...
                            <div class="text-base font-bold text-red-900">
                                <?php echo e(toMoney($selectedOrder->amount_discount ?? 0, 'R$ ')); ?></div>
                        </div>
                        <div class="bg-blue-50 rounded-lg p-3 border border-blue-200">
                            ...
                            <div class="text-base font-bold text-blue-900">
                                <?php echo e(toMoney($selectedOrder->amount_paid ?? 0, 'R$ ')); ?></div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos/resources/views/livewire/dashboard/dashboard-vendas-campanhas-realtime.blade.php ENDPATH**/ ?>