<div class="min-h-screen bg-white">
    ...
    <?php if($orderTickets ?? false): ?>
        ...
        <section class="relative w-full overflow-hidden" style="min-height: 240px;">
            ...
            <?php if($urlImageBg): ?>
                <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('<?php echo e($urlImageBg); ?>');"></div>
            ...
            <?php elseif($urlImage): ?>
                <div class="absolute inset-0 bg-cover bg-center bg-no-repeat scale-105" style="background-image: url('<?php echo e($urlImage); ?>'); filter: blur(2px) brightness(0.35);"></div>
            ...
            <div class="relative z-10 max-w-4xl mx-auto px-5 md:px-10 py-6 md:py-8 pb-16 md:pb-24">
                ...
                <div class="flex items-center justify-between w-full gap-3 mb-5">
                    <div class="flex items-center gap-4 min-w-0">
                        <?php if($urlImageLogo): ?>
                            <img class="h-10 md:h-12 w-auto drop-shadow-lg flex-shrink-0" src="<?php echo e($urlImageLogo); ?>" alt="">
                        <?php elseif($urlCustomerLogo): ?>
                            <img class="h-10 md:h-12 w-auto drop-shadow-lg flex-shrink-0" src="<?php echo e($urlCustomerLogo); ?>" alt="">
                        <?php else: ?>
                            <img class="h-10 md:h-12 w-auto drop-shadow-lg flex-shrink-0" src="<?php echo e(appLogo(true)); ?>" alt="<?php echo e(appName()); ?>">
                        <?php endif; ?>
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 md:px-4 py-2 text-xs font-semibold uppercase tracking-wider rounded-full shadow-lg flex-shrink-0"
                        ...
                        <?php echo e($orderTickets->count()); ?> <?php echo e($event->event_tickets_nomenclature ?? 'VOUCHER'); ?><?php echo e($orderTickets->count() > 1 ? 'S' : ''); ?>
                ...
                <h1 class="text-2xl md:text-4xl text-white font-extrabold uppercase tracking-tight drop-shadow-xl leading-tight"><?php echo e($event->event_name ?? '--'); ?></h1>

                <?php if($event->organizer->organizer_name_full ?? false): ?>
                    <p class="text-sm md:text-base mt-2 font-medium text-white/60 uppercase tracking-wide"><?php echo e($event->organizer->organizer_name_full); ?></p>
                <?php endif; ?>
        ...
        <div class="w-full max-w-4xl mx-auto px-4 md:px-10 -mt-10 md:-mt-14 relative z-20">
            ...
            <div class="w-full rounded-2xl bg-white shadow-xl overflow-hidden mb-6" style="border: 1px solid <?php echo e($colorPrimary); ?>18;">
                <div class="px-5 md:px-8 py-4" style="background: <?php echo e($colorPrimary); ?>08; border-bottom: 1px solid <?php echo e($colorPrimary); ?>15;">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
                        <div>
                            ...
                            <div class="text-lg md:text-xl font-bold text-gray-800 uppercase -mt-0.5"><?php echo e($order->order_control ?? '--'); ?></div>
                        </div>
                        <div class="text-right min-w-0 flex-1">
                            <div class="text-xs tracking-widest font-light text-gray-400 uppercase">COMPRADOR</div>
                            <div class="text-sm md:text-base font-semibold text-gray-700 uppercase -mt-0.5 truncate"><?php echo e($order->buyer_name ?? '--'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-5 pb-10">
                ...
                <?php $__currentLoopData = $orderTickets ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticketKey => $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div class="w-full rounded-2xl bg-white shadow-md overflow-hidden transition-all duration-200" style="border: 1px solid <?php echo e($colorPrimary); ?>18;">

                        
                        <div class="px-5 md:px-6 py-3 flex items-center justify-between gap-2" style="background: <?php echo e($colorPrimary); ?>08; border-bottom: 1px solid <?php echo e($colorPrimary); ?>15;">
                            <div class="flex items-center gap-2 min-w-0 w-full sm:w-auto">
                                <svg class="w-4 h-4 flex-shrink-0" style="color: <?php echo e($colorPrimary); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/></svg>
                                <span class="text-xs font-semibold uppercase tracking-widest text-gray-600">
                                    <?php echo e($event->event_tickets_nomenclature ?? 'VOUCHER'); ?>

                                    <span class="font-bold" style="color: <?php echo e($colorPrimary); ?>;"><?php echo e($ticket->type->ticket_name ?? null); ?></span>
                                </span>
                            </div>
                            <?php if(in_array($ticket->ticket_status, ['utilizado'])): ?>
                                <span class="inline-flex items-center gap-1 px-3 py-1 text-xs font-semibold uppercase tracking-wider rounded-full bg-green-100 text-green-700 border border-green-200 flex-shrink-0">
                                    ...
                                    <?php echo e(__($ticket->ticket_status)); ?>

                                </span>
                            <?php elseif(in_array($ticket->ticket_status, ['disponivel'])): ?>
                                <span class="inline-flex items-center gap-1 px-3 py-1 text-xs font-semibold uppercase tracking-wider rounded-full shadow-sm flex-shrink-0"
                                      style="background-color: <?php echo e($colorDefault); ?>22; color: <?php echo e($colorPrimary); ?>; border: 1px solid <?php echo e($colorDefault); ?>44;">
                                    <?php echo e(__($ticket->ticket_status)); ?>
                        ...
                        <div class="px-5 md:px-6 py-4">
                            <div class="flex flex-col md:flex-row gap-4 md:gap-6">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="text-lg md:text-xl font-bold text-gray-800 uppercase break-words"><?php echo e($ticket->user_name); ?></div>

                                    <div class="flex flex-col gap-1.5 mt-3">
                                        <?php if($ticket->user_email ?? false): ?>
                                            <div class="flex items-center gap-2 text-sm text-gray-500">
                                                ...
                                                <span class="lowercase break-all"><?php echo e($ticket->user_email); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        <?php if(($ticket->user_contact_ddd ?? false) || ($ticket->user_contact_num ?? false)): ?>
                                            <div class="flex items-center gap-2 text-sm text-gray-500">
                                                ...
                                                <span>(<?php echo e($ticket->user_contact_ddd ?? '--'); ?>) <?php echo e($ticket->user_contact_num ?? '--'); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($ticket->user_birth_date ?? false): ?>
                                            <div class="flex items-center gap-2 text-sm text-gray-500">
                                                ...
                                                <span><?php echo e($ticket->user_birth_date->format('d/m/Y')); ?> · <?php echo e($ticket->user_birth_date->age); ?> anos</span>
                                            </div>
                                        <?php endif; ?>
                                    </div>

                                    
                                    <div class="mt-3 pt-3" style="border-top: 1px solid <?php echo e($colorPrimary); ?>10;">
                                        <div class="flex items-center gap-2 text-sm text-gray-600">
                                            ...
                                            <span class="font-medium">
                                                <?php if($event->event_datetime_start): ?>
                                                    <?php echo e(\Carbon\Carbon::parse($event->event_datetime_start)->format('d/m/Y - H:i')); ?>

                                                    <?php if($event->event_datetime_finish): ?>
                                                        <?php if(\Carbon\Carbon::parse($event->event_datetime_start)->format('d/m/Y') == \Carbon\Carbon::parse($event->event_datetime_finish)->format('d/m/Y')): ?>
                                                            às <?php echo e(\Carbon\Carbon::parse($event->event_datetime_finish)->format('H:i')); ?>

                                                        <?php else: ?>
                                                            até <?php echo e(\Carbon\Carbon::parse($event->event_datetime_finish)->format('d/m/Y - H:i')); ?>
                                ...
                                <div class="flex flex-col items-center justify-center gap-2 flex-shrink-0">
                                    <?php if(in_array($ticket->ticket_status, ['disponivel'])): ?>
                                        <div class="p-3 rounded-xl bg-white shadow-sm" style="border: 2px solid <?php echo e($colorPrimary); ?>30;">
                                            <?php echo e(\QrCode::size(120)->generate($ticket->ticket_control)); ?>

                                        </div>
                                    <?php else: ?>
                                        <div class="p-3 rounded-xl bg-gray-50 opacity-50" style="border: 2px dashed <?php echo e($colorPrimary); ?>25;">
                                            <?php echo e(\QrCode::size(120)->generate($ticket->ticket_control)); ?>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-xs font-mono font-semibold text-gray-500 break-all max-w-[150px]"><?php echo e($ticket->ticket_control); ?></div>
                                    </div>
                                </div>
                        ...
                        <div class="px-5 md:px-6 py-2.5 text-center" style="background: <?php echo e($colorPrimary); ?>05; border-top: 1px dashed <?php echo e($colorPrimary); ?>20;">
                            <span class="text-xs text-gray-400 uppercase tracking-wider"><?php echo e($event->organizer->organizer_name_full ?? null); ?></span>
                        </div>
    ...
    <?php else: ?>
        ...
        <div class="min-h-[60vh] flex flex-col items-center justify-center px-6 py-12">
            <img src="<?php echo e(asset('images/app/assets/404.gif')); ?>" class="w-48 md:w-64 mb-6" alt="">
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/livewire/app-evento-ingresso.blade.php ENDPATH**/ ?>