...
<script src="https://campanhas.proeventpay.com/wireui/assets/scripts?id=be97ebae74d62aa4c86689a6528b707f" defer ></script>
...
} elseif ($_instance->childHasBeenRendered('jsIL22A')) {
    $componentId = $_instance->getRenderedChildComponentId('jsIL22A');
    $componentTag = $_instance->getRenderedChildComponentTagName('jsIL22A');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jsIL22A');
} else {
    $response = \Livewire\Livewire::mount('navigation.navigation-menu-pep-guest');
    $html = $response->html();
    $_instance->logRenderedChild('jsIL22A', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/proev836/public_html_sistemas/app_eventos/resources/views/layouts/app-pep-guest.blade.php ENDPATH**/ ?>