...
} elseif ($_instance->childHasBeenRendered('l2361168532-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2361168532-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2361168532-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2361168532-0');
} else {
    $response = \Livewire\Livewire::mount('faturamento.validar-fatura');
    $html = $response->html();
    $_instance->logRenderedChild('l2361168532-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

</div>
<?php /**PATH /home/proev836/public_html_sistemas/app_eventos/resources/views/livewire/dashboard/dashboard.blade.php ENDPATH**/ ?>