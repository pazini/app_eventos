...
<?php endif; ?>
        ...
        <input <?php echo e($attributes->class([
                $getInputClasses($hasError),'rounded-none',
            ])->merge([
                'type'         => 'text',
                'autocomplete' => 'off',
            ])); ?> />
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/vendor/wireui/components/input.blade.php ENDPATH**/ ?>