...
<script src="https://painel.proeventpay.com.br/wireui/assets/scripts?id=be97ebae74d62aa4c86689a6528b707f" defer ></script>
...
} elseif ($_instance->childHasBeenRendered('vsAzeSL')) {
    $componentId = $_instance->getRenderedChildComponentId('vsAzeSL');
    $componentTag = $_instance->getRenderedChildComponentTagName('vsAzeSL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vsAzeSL');
} else {
    $response = \Livewire\Livewire::mount('navigation.navigation-menu-pep-auth');
    $html = $response->html();
    $_instance->logRenderedChild('vsAzeSL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/layouts/app-pep-auth.blade.php ENDPATH**/ ?>