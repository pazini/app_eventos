...
} elseif ($_instance->childHasBeenRendered('LWMtCiA')) {
    $componentId = $_instance->getRenderedChildComponentId('LWMtCiA');
    $componentTag = $_instance->getRenderedChildComponentTagName('LWMtCiA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LWMtCiA');
} else {
    $response = \Livewire\Livewire::mount('navigation.navigation-menu-pep-guest');
    $html = $response->html();
    $_instance->logRenderedChild('LWMtCiA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/layouts/app-pep-guest.blade.php ENDPATH**/ ?>