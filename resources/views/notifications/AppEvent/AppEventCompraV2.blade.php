                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0;padding-bottom:10px">
                                                                    <h2 style="text-align: center; Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#333333">{{ $data['payment']['description'] ?? 'EVENTO' }}</h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0;padding-top:15px;padding-bottom:20px">
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:36px;color:#777777;font-size:24px; text-align: center;"><strong class="font-size:28px;">{{ $data['nome'] }}</strong>, compa confirmada! Segue abaixo todas as informações e link para acesso online.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                    ...
                                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:500px" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation">
                                                                        <tr style="border-collapse:collapse">
                                                                            <td width="80%" style="padding:0;Margin:0">
                                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">LOCALIZADOR</h4>
                                                                            </td>
                                                                            <td width="20%" style="padding:0;Margin:0">
                                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 186x; color: rgb(95, 95, 95);">{{ $data['order_control'] }}</h4>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                            ...
                                                                            @foreach ($data['tickets'] as $ticketKey => $ticketValues)
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td style="padding:5px 10px 5px 0;Margin:0" width="80%" align="left">
                                                                                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:16px">{{ $ticketValues['event_name'] ?? null }}</p>
                                                                                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:12px">INGRESSO {{ $ticketValues['ticket_control'] ?? null }}</p>
                                                                                    </td>
                                                                                    <td style="padding:5px 0;Margin:0" width="20%" align="left">
                                                                                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:16px">{{ ($ticketValues['event_ticket_price'] ?? false) ? 'R$ ' . number_format(($ticketValues['event_ticket_price'] ?? 0) / 100 , 2, ',', '.') : '--' }}</p>
                                                                                    </td>
                                                                                </tr>
                                                                            @endforeach
                                                                        </table>
                                                                    ...
                                                                    <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:15px;padding-bottom:15px">
                                                                        <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:500px" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation">
                                                                            <tr style="border-collapse:collapse">
                                                                                ...
                                                                                <td width="20%" style="padding:0;Margin:0">
                                                                                    <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">{{ ($data['payment']['value_paid'] ?? false) ? 'R$ ' . number_format(($data['payment']['value_paid'] ?? 0) / 100 , 2, ',', '.') : '--' }}</h4>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <table>
                                                                            <tr>
                                                                                <td width="100%" style="padding:0; Margin:0; font-size: 16px; color: rgb(95, 95, 95); ">

                                                                                    <span>{{ $data['payment']['paid_label'] ?? null }}</span>
                                                                                    ...
                                                                                    @elseif ($data['payment']['pay_type'] == "BOLETO")
                                                                                        <div>
                                                                                            <span>PAGAMENTO EM BOLETO</span>
                                                                                        </div>
                                                                                        <div style="text-transform: uppercase;">
                                                                                            <span>NSU: </span>
                                                                                            <span>{{ $data['payment']['pay_nsu'] }}</span>
                                                                                        </div>
                                                                                    @elseif ($data['payment']['pay_type'] == "PIX")
                                                                                        <div>
                                                                                            <span>PAGAMENTO EM PIX</span>
                                                                                        </div>
                                                                                        <div style="text-transform: uppercase;">
                                                                                            <span>NSU: </span>
                                                                                            <span>{{ $data['payment']['pay_nsu'] }}</span>
                                                                                        </div>
                                                                                    @elseif ($data['payment']['pay_type'] == "CUPOM_FULL")
                                                                                        <div>
                                                                                            <span>PAGAMENTO EM CUPOM FULL - 100% DE DESCONTO</span>
                                                                                        </div>
                                                                                    @endif
                                                                                </td>
                                                                            </tr>
                                ...
                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px;">
                                    <tr>
                                        <td style="padding-top:30px;padding-bottom:30px;">
                                            ...
                                            @if ($data['event']['notification_text_1'] ?? false)
                                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px;">
                                                    <tr style="border-collapse:collapse">
                                                        <td align="center" style="font-size: 20px; color: #5b5b5b; font-weight: bold; margin:0;padding:0;padding-left:35px;padding-right:35px">
                                                            {{ $data['event']['notification_text_1'] }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            @endif
                                            @if ($data['event']['notification_text_2'] ?? false)
                                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px;">
                                                    <tr style="border-collapse:collapse">
                                                        <td align="center" style="font-size: 20px; color: #5b5b5b; margin:0;padding:0;padding-left:35px;padding-right:35px">
                                                            {{ $data['event']['notification_text_2'] }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            @endif
                                                ...
                                                <tr style="border-collapse:collapse">
                                                    <td valign="top" align="center" style="padding:0;Margin:0;width:530px">
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0;">
                                                                    <h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:24px;font-style:normal;font-weight:bold;color:#ffffff; text-align: center">MEUS INGRESSOS</h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
