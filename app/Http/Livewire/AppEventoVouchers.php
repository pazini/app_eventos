...
class AppEventoVouchers extends Component
{
    public $event_slug;
    ...
    public function mount($localizador, $order_id, $order_control_dv=false)
    {
        $this->order_control    = $localizador;
    ...
    public function render()
    {
        try
        {
            $this->order = AppEventOrder::with(['event','event.organizer','tickets'])->where('id',$this->order_id)->first();
