...
} elseif ($_instance->childHasBeenRendered('l1397588422-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1397588422-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1397588422-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1397588422-0');
} else {
    $response = \Livewire\Livewire::mount('faturamento.calcula-vendidos', ['eventId' => $event_item->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l1397588422-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php
...
} elseif ($_instance->childHasBeenRendered('l1397588422-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1397588422-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1397588422-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1397588422-1');
} else {
    $response = \Livewire\Livewire::mount('faturamento.calcula-vendidos-qtd', ['eventId' => $event_item->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l1397588422-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </td>
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/faturamento/faturamento.blade.php ENDPATH**/ ?>