...
} elseif ($_instance->childHasBeenRendered('l4140782665-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4140782665-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4140782665-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4140782665-0');
} else {
    $response = \Livewire\Livewire::mount('compras.modulo-pagamento', ['orderId' => $order->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l4140782665-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/livewire/compras/compra-exibir.blade.php ENDPATH**/ ?>