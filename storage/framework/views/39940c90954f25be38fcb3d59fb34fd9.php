            ...
            <div class="bg-white shadow-sm border-x border-b rounded-b-lg">
                ...
                <div class="p-6">
                    ...
                    <table id="table" class="display" style="width:100%">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $receitas ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receita_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-sm uppercase whitespace-nowrap">
                                    <?php echo e($receita_item['grupo'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap">
                                    <?php echo e($receita_item['descricao'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-right">
                                    <?php echo e($receita_item['valor'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-center">
                                    <?php echo e($receita_item['quantidade'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-right font-semibold text-green-600">
                                    <?php echo e($receita_item['total'] ?? '-'); ?>

                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $despesas ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $despesa_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="text-sm uppercase whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">DESPESA</span>
                                </td>
                                <td class="text-sm uppercase whitespace-nowrap">
                                    <?php echo e($despesa_item['grupo'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap">
                                    <?php echo e($despesa_item['descricao'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-right">
                                    <?php echo e($despesa_item['valor'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-center">
                                    <?php echo e($despesa_item['quantidade'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-right font-semibold text-red-600">
                                    <?php echo e($despesa_item['total'] ?? '-'); ?>

                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $saldos ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saldo_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="bg-gray-50 font-bold">
                                <td class="text-sm uppercase whitespace-nowrap">
                                    <?php echo e($saldo_item['tipo'] ?? null); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap">
                                    <?php echo e($saldo_item['grupo'] ?? null); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap">
                                    <?php echo e($saldo_item['descricao'] ?? null); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-right">
                                    <?php echo e($saldo_item['valor'] ??  null); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-center">
                                    <?php echo e($saldo_item['quantidade'] ?? '-'); ?>

                                </td>
                                <td class="text-sm uppercase whitespace-nowrap text-right text-lg">
                                    <?php echo e($saldo_item['total'] ?? '-'); ?>
                    ...
                    <script>
                        document.title = '<?php echo e(mb_strtoupper($target->event_name)); ?>-GESTAO-ORÇAMENTARIA-<?php echo e(now()->format("Ymd-Hi")); ?>';
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos/resources/views/livewire/dashboard/financeiro/gestao-orcamentaria-planilha.blade.php ENDPATH**/ ?>