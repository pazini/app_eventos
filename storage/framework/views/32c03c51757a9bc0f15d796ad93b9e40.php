    ...
    <div style="max-width:600px; margin:0 auto; background-color:#fff; border:1px solid #ddd; border-radius:8px; overflow:hidden;">
        ...
        <div style="padding:10px 20px;">
            ...
            <h1 style="margin:10px 0 20px 0; text-align:center;text-transform:uppercase;">
                ...
                <div style="font-size:15px; color:#1c3a1d;"><?php echo e($payment->order->event->event_name ?? null); ?></div>
            </h1>

            <?php if($payment->slip ?? false): ?>
                <!-- Informações Carnê -->
                <table style="box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);margin-bottom:10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);width: 100% !important; border-collapse:collapse; margin-bottom:20px; border:1px solid #ddd; border-radius:8px; overflow:hidden;">
                    <tr>
                        <th style="border-top:1px solid rgb(177, 177, 177); padding:10px; font-weight:bold; background-color:#4CAF50; text-align:left; color:#fff;text-transform:uppercase;">CARNÊ ONLINE <?php echo e(__($payment->slip->installment_pay_type ?? null)); ?></th>
                    ...
                    <tr style="background-color:#F5F5F5;">
                        ...
                        <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                            <div style="font-weight:bold; color:#333;"><?php echo e(mb_strtoupper(__($payment->slip->installment_description ?? '---'))); ?></div>
                        </td>
                    </tr>
                    <tr style="background-color:#F5F5F5;">
                        ...
                        <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                            <div style="font-weight:bold; color:#333;"><?php echo e(dataData($payment->slip->installment_date_due)); ?></div>
                        </td>
                    </tr>
                    <tr style="background-color:#F5F5F5;">
                        ...
                        <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                            <div style="font-weight:bold; color:#333;"><?php echo e(toMoney($payment->slip->installment_value,'R$ ')); ?></div>
                        </td>
                    </tr>
                </table>
            <?php endif; ?>
            ...
            <table style="box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);width: 100% !important; border-collapse:collapse; margin-bottom:20px; border:1px solid #ddd; border-radius:8px; overflow:hidden;">
                <tr>
                    <th style="border-top:1px solid rgb(177, 177, 177); padding:10px; font-weight:bold; background-color:#4CAF50; text-align:left; color:#fff;">
                        <div><?php echo e(mb_strtoupper($payment->paid_description ?? ($payment->pay_type ?? '---'))); ?></div>
                    </th>
                    <th style="border-top:1px solid rgb(177, 177, 177); padding:10px; background-color:#4CAF50; text-align:right; color:#fff;">
                        <div><?php echo e($payment->order->order_control ?? null); ?></div>
                    </th>
                </tr>
                <tr style="background-color:#F5F5F5;">
                    ...
                    <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                        <div style="font-weight:bold; color:#333;"><?php echo e(mb_strtoupper(__($payment->status ?? '---'))); ?></div>
                    </td>
                </tr>
                <tr style="background-color:#F5F5F5;">
                    ...
                    <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                        <div style="color:#333;"><?php echo e(mb_strtoupper(($payment->pay_nsu ?? false) ? $payment->pay_nsu : '---')); ?></div>
                    </td>
                </tr>
                <tr style="background-color:#F5F5F5;">
                    ...
                    <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                        <div style="color:#333;"><?php echo e(($payment->pay_datetime ?? false) ? dataDataHora($payment->pay_datetime) : 'Não informada'); ?></div>
                    </td>
                </tr>

                <?php if($payment->value_fees ?? false): ?>
                    <tr style="background-color:#F5F5F5;">
                        ...
                        <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                            <div style="color:#333;"><?php echo e(convertMoney($payment->value_liquid, 'R$ ')); ?></div>
                        </td>
                    </tr>
                    <tr style="background-color:#F5F5F5;">
                        ...
                        <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                            <div style="color:#333;"><?php echo e(convertMoney($payment->value_fees, 'R$ ')); ?></div>
                        </td>
                    </tr>
                <?php endif; ?>
                ...
                <tr style="background-color:#F5F5F5;">
                    ...
                    <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                        <div>
                            <span style="color:#333;"><?php echo e(convertMoney($payment->value_paid, 'R$ ')); ?></span>
                            <?php if($payment->pay_installments_number > 1): ?>
                            <span style="color:#949494;">(<?php echo e($payment->pay_installments_number ?? null); ?>x <?php echo e(convertMoney($payment->pay_installment_value,'R$ ')); ?>)</span>
                            <?php endif; ?>
                        </div>
                    </td>
                </tr>
                <?php if($payment->pay_card_first ?? FALSE): ?>
                    <tr style="background-color:#F5F5F5;">
                        ...
                        <td style="background-color:#F5F5F5; border-top:1px solid rgb(177, 177, 177); padding:10px; text-align:right;">
                            <span style="color:#333;"><?php echo e($payment->pay_card_first ?? '****'); ?></span>
                            <span style="color:#333;">**** ****</span>
                            <span style="color:#333;"><?php echo e($payment->pay_card_last ?? '****'); ?></span>
                        </td>
                    </tr>
                <?php endif; ?>
            </table>
            ...
            <div style="text-align:center; margin:20px 0;">
                <a href="<?php echo e(route('compra-exibir', ['localizador' => $payment->order->order_control])); ?>"
                    target="_blank"
            ...
            <div style="text-align:center; font-size:14px; margin-top:20px; border:1px solid #ddd; border-radius:8px; padding:10px;">
                <?php if(($payment->order->event->organizer ?? false) && $payment->order->event->organizer->owner_phone_ddd && $payment->order->event->organizer->owner_phone_num): ?>
                    <p>Dúvidas? Fale com o organizador pelo Telefone / WhatsApp <strong><?php echo e(putMask($payment->order->event->organizer->owner_phone_ddd.$payment->order->event->organizer->owner_phone_num,'telefone')); ?></strong></p>
                <?php else: ?>
                    <p>Dúvidas? Fale com a empresa pelo Telefone / WhatsApp <strong><?php echo e(putMask($payment->order->event->customer->comercial_contact_ddd.$payment->order->event->customer->comercial_contact_num,'telefone')); ?></strong></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/_email/compra/pagamento-confirmado.blade.php ENDPATH**/ ?>