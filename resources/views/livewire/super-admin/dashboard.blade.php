            ...
            <div class="p-6 border-b border-gray-200">
                <div>
                    ...
                    <div class="grid grid-cols-6 gap-3">
                        <div>
                            <a
                                href="{{ route('super-administrador.apps.create') }}"
                        ...
                        <div>
                            <a
                                href="{{ route('super-administrador.apps.index') }}"
                        ...
                        <div>
                            <a
                                href="{{ route('super-administrador.listas') }}"
                        ...
                        <div>
                            <a
                                href="{{ route('super-administrador.sql') }}"
                        ...
                        <div class="ml-4 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ $stats['apps']['total'] ?? 0 }}
                                    @if(($stats['apps']['active'] ?? 0) > 0)
                                        <span class="text-xs text-green-600 block">({{ $stats['apps']['active'] }} ativas)</span>
                                    @endif
                                </dd>
                            </dl>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ $stats['users']['total'] ?? 0 }}
                                    @if(($stats['users']['verified'] ?? 0) > 0)
                                        <span class="text-xs text-green-600 block">({{ $stats['users']['verified'] }} verificados)</span>
                                    @endif
                                </dd>
                            </dl>
                        </div>
                        ...
                        <div class="ml-4 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    ...
                                    @if(($stats['customers']['this_month'] ?? 0) > 0)
                                        <span class="text-xs text-indigo-600 block">(+{{ $stats['customers']['this_month'] }} este mês)</span>
                                    @endif
                                </dd>
                            </dl>
                        </div>
                        ...
                        <div class="ml-4 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    ...
                                    @if(($stats['campaigns']['this_month'] ?? 0) > 0)
                                        <span class="text-xs text-blue-600 block">(+{{ $stats['campaigns']['this_month'] }} este mês)</span>
                                    @endif
                                </dd>
                            </dl>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ number_format($stats['storage']['used_mb'] ?? 0, 1) }} MB
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="bg-white shadow-sm overflow-hidden sm:rounded-lg border border-gray-200">
                ...
                @if(count($apps) > 0)
                    <ul class="divide-y divide-gray-200">
                        @foreach($apps as $app)
                            <li>
                                <a href="{{ route('super-administrador.apps.edit', $app['id']) }}" class="block hover:bg-gray-50 transition duration-150 ease-in-out">
                                    <div class="px-6 py-4">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-3 w-3 rounded-full"
                                                     style="background-color: {{ $app['colors']['primary'] ?? '#1a202c' }}">
                                                </div>
                                                <div class="ml-3">
                                            ...
                                            <div class="sm:flex sm:justify-between">
                                                <div class="sm:flex">
                                                    <p class="flex items-center text-sm text-gray-500">
                                                        {{ $app['customers_count'] ?? 0 }} clientes
                                                    </p>
                                                    <p class="mt-2 flex items-center text-sm text-gray-500 sm:mt-0 sm:ml-6">
                                                        {{ $app['campaigns_count'] ?? 0 }} campanhas
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="px-6 py-3 bg-gray-50 border-t border-gray-200 text-center">
                        <a href="{{ route('super-administrador.apps.index') }}" class="text-sm text-blue-600 hover:text-blue-500 font-medium">
                ...
                @else
                    <div class="px-6 py-8 text-center">
                        ...
                        <a href="{{ route('super-administrador.apps.create') }}" class="mt-2 text-blue-600 hover:text-blue-500 font-medium">
                                    ...
                                    <li>
                                        <div class="relative pb-6">
                                            ...
                                            <div class="relative flex space-x-3">
                                                <div>
                                                    <span class="h-8 w-8 rounded-full bg-{{ $activity['color'] ?? 'green' }}-500 flex items-center justify-center ring-8 ring-white">
