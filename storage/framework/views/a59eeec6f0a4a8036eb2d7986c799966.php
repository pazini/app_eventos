...
} elseif ($_instance->childHasBeenRendered('l2968992246-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2968992246-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2968992246-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2968992246-0');
} else {
    $response = \Livewire\Livewire::mount('compras.modulo-pagamento', ['orderId' => $order->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l2968992246-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH /home/proev836/public_html_sistemas/app_eventos/resources/views/livewire/compras/compra-exibir.blade.php ENDPATH**/ ?>