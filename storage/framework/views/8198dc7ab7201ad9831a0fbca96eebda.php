...
} elseif ($_instance->childHasBeenRendered('l2172258213-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2172258213-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2172258213-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2172258213-0');
} else {
    $response = \Livewire\Livewire::mount('faturamento.validar-fatura');
    $html = $response->html();
    $_instance->logRenderedChild('l2172258213-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

</div>
<?php /**PATH /home/igrnc24/public_html_sistemas/campanhas-eventos-proeventpay-transicao/resources/views/livewire/dashboard/dashboard.blade.php ENDPATH**/ ?>