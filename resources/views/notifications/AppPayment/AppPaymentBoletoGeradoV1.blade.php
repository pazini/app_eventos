                                        ...
                                        <table cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:100%">
                                                    <h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:36px;font-style:normal;font-weight:bold;color:#ffffff">Boleto gerado</h1>
                                                    <h4 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;font-style:normal;font-weight:600;color:#ffffff">Efetue o pagamento para garantir sua inscrição</h4 >
                                                </td>
                                            </tr>
                                        </table>
                                        </td>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0;padding-bottom:10px">
                                                                    <h2 style="text-align: center; Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#333333">{{ $data['order']['payment']['description'] ?? 'EVENTO' }}</h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="padding:0;Margin:0;padding-top:15px;">
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:36px;color:#777777;font-size:24px;text-align: center;"><strong class="font-size:30px;">{{ $data['nome'] ?? 'USUÁRIO'}}</strong>, geramos um boleto para pagamento com vencimento em <strong>{{ $data['order']['payment']['pay_boleto_expiration_date'] ?? '--/--/----' }}</strong>. Efetue o pagamento clicando no link abaixo para acessar seu boleto online ou pode utilize o CODIGO DE BARRAS DIGITÁVEL que esta logo abaixo no email.</p>
                                                                </td>
                                                            </tr>
                                                            @if ($data['line_aditional'] ?? false)
                                                                <tr style="border-collapse:collapse">
                                                                    <td align="left" style="padding:0;Margin:0;padding-top:15px;padding-bottom:20px">
                                                                        <div style="color: rgb(163, 27, 27); font-size: 18px; text-align: center; font-weight: 900;">
                                                                            {{ $data['line_aditional']['line_aditional_top_titulo'] ?? null }}
                                                                        </div>
                                                                        <div style="color: rgb(163, 27, 27); font-size: 18px; text-align: center;">
                                                                            {{ $data['line_aditional']['line_aditional_top_texto'] ?? null }}
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                                    ...
                                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:500px" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation">
                                                                        <tr style="border-collapse:collapse">
                                                                            ...
                                                                            <td width="20%" style="padding:0;Margin:0">
                                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 186x; color: rgb(95, 95, 95);">{{ $data['order']['order_control'] }}</h4>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:15px;padding-bottom:15px">
                                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:500px" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation">
                                                                        <tr style="border-collapse:collapse">
                                                                            <td width="80%" style="padding:0;Margin:0">
                                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">VALOR A SER PAGO</h4>
                                                                            </td>
                                                                            <td width="20%" style="padding:0;Margin:0">
                                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; font-size: 16px; color: rgb(95, 95, 95);">{{ ($data['order']['payment']['value_liquid'] ?? false) ? 'R$ ' . number_format(($data['order']['payment']['value_liquid'] ?? 0) / 100 , 2, ',', '.') : '--' }}</h4>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <table>
                                                                        <tr>
                                                                            <td width="100%" style="padding:0; Margin:0; font-size: 16px; color: rgb(95, 95, 95); ">
                                                                                ...
                                                                                @if ($data['order']['payment']['pay_type'] == "CREDIT_CARD")
                                                                                    <div style="text-transform: uppercase;">
                                                                                        <span>CARTÃO DE CRÉDITO - </span>
                                                                                        <span>{{ $data['order']['payment']['pay_card_brand'] ?? '--' }}</span>
                                                                                        <span>{{ $data['order']['payment']['pay_card_first'] ?? '----' }}</span>
                                                                                        <span>* * * *</span>
                                                                                        <span>{{ $data['order']['payment']['pay_card_last'] ?? '----' }}</span>
                                                                                    </div>
                                                                                    <div style="text-transform: uppercase;">
                                                                                        <span>NSU: </span>
                                                                                        <span>{{ $data['order']['payment']['pay_nsu'] ?? '--' }}</span>
                                                                                    </div>
                                                                                @elseif ($data['order']['payment']['pay_type'] == "BOLETO")
                                                                                    <div>
                                                                                        <span>VENCIMENTO: </span>
                                                                                        <span>{{ $data['order']['payment']['pay_boleto_expiration_date'] ?? '--' }}</span>
                                                                                    </div>
                                                                                @endif
                                                                            </td>
                                                                        </tr>
                                ...
                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px;">
                                    <tr>
                                        <td style="padding-top:30px;padding-bottom:30px;">
                                            ...
                                            @if ($data['line_aditional']['line_aditional_botton_titulo'] ?? false)
                                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px;">
                                                    <tr style="border-collapse:collapse">
                                                        <td align="center" style="font-size: 20px; color: #5b5b5b; font-weight: bold; margin:0;padding:0;padding-left:35px;padding-right:35px">
                                                            {{ $data['line_aditional']['line_aditional_botton_titulo'] }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            @endif
                                            @if ($data['line_aditional']['line_aditional_botton_texto'] ?? false)
                                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px;">
                                                    <tr style="border-collapse:collapse">
                                                        <td align="center" style="font-size: 20px; color: #5b5b5b; margin:0;padding:0;padding-left:35px;padding-right:35px">
                                                            {{ $data['line_aditional']['line_aditional_botton_texto'] }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            @endif
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                    <td valign="top" align="center" style="padding:0;Margin:0;width:530px">
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;">
                                                                    <span class="es-button-border" style="border-style:solid;border-color:transparent;background:#66B3B7;border-width:0px;display:inline-block;border-radius:5px;width:auto">
                                                                        <a href="{{ $data['order']['payment']['pay_boleto_url'] ?? '#' }}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;border-style:solid;border-color:#66B3B7;border-width:15px 30px 15px 30px;display:inline-block;background:#66B3B7;border-radius:5px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center">IMPRIMIR BOLETO</a>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px">
                                                                    <div style="color: #ffffff; margin: 0; font-size: 20px; font-weight: 400; margin-bottom: 5px;">CODIGO DE BARRAS DIGITÁVEL</div>
                                                                    <div style="color: #ffffff; margin: 0; font-size: 20px; font-weight: bold;">{{ $data['order']['payment']['pay_boleto_barcode'] ?? '-- -- -- --' }}</div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
