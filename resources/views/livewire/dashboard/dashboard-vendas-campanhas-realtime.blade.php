                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach ($orders ?? [] as $order_item)
                            ...
                            <tr class="hover:bg-gray-50 cursor-pointer"
                                ...
                                <td class="px-4 py-3">
                                    <div class="text-sm text-gray-700">{{ $order_item->campaign->name ?? '--' }}
                                    </div>
                                    <div class="text-xs text-gray-500 uppercase">
                                        {{ $order_item->campaign->organizer->organizer_name_full ?? '--' }}</div>
                                </td>
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <x-button sm primary outline icon="link"
                            href="{{ route('adesao-localizador', ['localizador' => $selectedOrder->order_control]) }}"
                            target="_blank" label="Abrir Adesão" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        ...
                        <div class="text-base font-semibold text-gray-900">
                            {{ $selectedOrder->campaign->organizer->organizer_name_full ?? '--' }}</div>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div class="text-xs font-medium text-gray-500 uppercase mb-1">Campanha</div>
                        <div class="text-base font-semibold text-gray-900">
                            {{ $selectedOrder->campaign->name ?? '--' }}</div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-white rounded-lg p-3 border border-gray-200">
                            ...
                            <div class="text-sm font-semibold text-gray-900">
                                {{ ($selectedOrder->buyer_contact_country ?? '55') . ' ' . ($selectedOrder->buyer_contact_ddd ?? '') . ' ' . ($selectedOrder->buyer_contact_num ?? '') }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-white rounded-lg p-3 border border-gray-200">
                            ...
                            <div class="text-base font-bold text-gray-900">
                                {{ toMoney($selectedOrder->amount_total ?? 0, 'R$ ') }}</div>
                        </div>
                        <div class="bg-red-50 rounded-lg p-3 border border-red-200">
                            ...
                            <div class="text-base font-bold text-red-900">
                                {{ toMoney($selectedOrder->amount_discount ?? 0, 'R$ ') }}</div>
                        </div>
                        <div class="bg-blue-50 rounded-lg p-3 border border-blue-200">
                            ...
                            <div class="text-base font-bold text-blue-900">
                                {{ toMoney($selectedOrder->amount_paid ?? 0, 'R$ ') }}</div>
                        </div>
                    </div>
                </div>
