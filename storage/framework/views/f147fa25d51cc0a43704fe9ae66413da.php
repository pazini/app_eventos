...
<script src="https://painel.proeventpay.com/wireui/assets/scripts?id=be97ebae74d62aa4c86689a6528b707f" defer ></script>
...
} elseif ($_instance->childHasBeenRendered('Ki7V9iv')) {
    $componentId = $_instance->getRenderedChildComponentId('Ki7V9iv');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ki7V9iv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ki7V9iv');
} else {
    $response = \Livewire\Livewire::mount('navigation.navigation-menu-pep-auth');
    $html = $response->html();
    $_instance->logRenderedChild('Ki7V9iv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/proev836/public_html_sistemas/app_eventos/resources/views/layouts/app-pep-auth.blade.php ENDPATH**/ ?>